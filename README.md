...
- Train & walk-through full Data Science cycle/process capturing transformation from raw, messy real-world dataset into tidy form and the output/model, visualization or final document/published via Data.World RPubs or as Jupyter notebook with IRkernel via GitHub
...
- Others can/will be able to vote & rank (https://data.world, http://rpubs.com, or your own GitHub repo/Jupyter notebook)
